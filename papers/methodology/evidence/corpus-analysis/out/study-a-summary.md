...
> **Corpus snapshot:** openwop@3852e30c · openwop-app@eb53aeb0
...
| Status | Count | Share |
|---|---|---|
| Implemented | 146 | 88.0% |
| Accepted | 11 | 6.6% |
| Superseded | 6 | 3.6% |
| Proposed | 2 | 1.2% |
| Withdrawn | 1 | 0.6% |

- ADRs carrying a **correction note** (a decision revisited/overturned in flight): **65** (39.2%).
...
Of the 166 ADRs, the transparent classifier (rules in `analyze-corpus.mjs`)
...
|---|---|---|---|
| host-extension | 87 | 52.4% | 54.0% |
| rides-accepted | 42 | 25.3% | 26.1% |
| new-rfc | 32 | 19.3% | 19.9% |
| unclassified | 5 | 3.0% | — |
