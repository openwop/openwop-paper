...
gate is highly selective: of 159 classifiable decision records in our estate, 155 (97.5\%) resolved
...
The conformance suite at this snapshot is version 1.37.0 (370 scenarios, 82 fixtures); its growth over
...
we audited from each record's explicit gate declaration (Section~10); 5 of 164 records remain
...
methodology; shown, across a real 110-RFC, two-host estate, that it keeps 97.5\% of change off the wire
