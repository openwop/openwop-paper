...
\paragraph{Study B (honesty experiment; \emph{Demonstrated}).} \TODO{The reproducible
advertise-without-implement $\rightarrow$ strict-mode-fails $\rightarrow$ implement $\rightarrow$ passes
experiment, captured into \texttt{evidence/methodology/}.}
